  ...
  return (
    <section id="contact" className="py-24 bg-dark-900 text-white relative">
      <div className="container mx-auto px-6">
        <div className="flex flex-col lg:flex-row gap-16">
          ...
          >
            ...
            <p className="text-neutral-400 mb-10 text-lg">
              Ready to start your journey? Visit us or drop a message. We are here to help you achieve your fitness goals.
            </p>
            ...
            <div className="mt-12">
              ...
              <div className="flex gap-4">
                {[Instagram, MessageCircle, Youtube].map((Icon, i) => (
                  <a key={i} href="#" className="w-10 h-10 rounded-full bg-dark-800 flex items-center justify-center hover:bg-primary transition-colors duration-300">
        ...
        <div className="mt-20 pt-8 border-t border-dark-800 text-center text-neutral-500 text-sm">
